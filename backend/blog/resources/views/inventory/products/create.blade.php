            ...
            <form action="{{ route('inventory.products.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" rows="4"
                              class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 outline-none transition resize-y">{{ old('description') }}</textarea>
                </div>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Bar Code</label>
                    <input type="text" name="barcode" value="{{ old('barcode', 0) }}" min="0" required
                           class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Purchase Price</label>
                    <input type="text" name="purchase_price" value="{{ old('purchase_price', 0) }}" min="0" required
                           class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                </div>

              
                 <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Selling Price/MRP</label>
                    <input type="text" name="selling_price" value="{{ old('selling_price', 0) }}" min="0" required
                           class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">MFD</label>
                    <input type="date" name="mfd_date" value="{{ old('mfd_date', 0) }}" min="0" required
                           class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Exp</label>
                    <input type="date" name="exp_date" value="{{ old('exp_date', 0) }}" min="0" required
                           class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                </div>
