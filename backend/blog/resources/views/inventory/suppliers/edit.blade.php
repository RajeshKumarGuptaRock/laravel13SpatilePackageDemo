    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white p-6 md:p-8 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="{{ route('inventory.suppliers.index') }}" class="text-gray-600 hover:text-gray-900 underline text-sm transition">Back</a>
            </div>
            ...
            <form action="{{ route('inventory.suppliers.update', $supplier) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="address" rows="4"
                              class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 outline-none transition resize-y">{{ old('address', $supplier->address) }}</textarea>
                </div>
