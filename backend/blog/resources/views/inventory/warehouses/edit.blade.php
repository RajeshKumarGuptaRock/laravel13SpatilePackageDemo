            ...
            <form action="{{ route('inventory.warehouses.update', $warehouse) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="address" rows="4"
                              class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 outline-none transition resize-y">{{ old('address', $warehouse->address) }}</textarea>
                </div>
